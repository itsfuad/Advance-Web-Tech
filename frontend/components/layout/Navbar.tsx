      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <Link href="/" className="flex items-center gap-3">
            <Image src="/icon.png" alt="Fundrise" width={32} height={32} className="rounded" />
                ...
                {accountOpen && (
                  <div className="absolute right-0 top-full z-50 mt-2 w-72 overflow-hidden rounded-lg border border-(--border) bg-(--background) text-(--foreground) shadow-lg">
                    ...
                    <button
                      ...
                      className="text-red-500 cursor-pointer flex w-full items-center gap-3 px-4 py-3 text-sm text-left transition-colors hover:bg-(--secondary-hover)"
                    >
                      <LogOut size={16} />
                      Logout
                    </button>
